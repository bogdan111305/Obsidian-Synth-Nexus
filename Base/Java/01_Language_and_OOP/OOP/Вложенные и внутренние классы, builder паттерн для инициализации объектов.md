...
> [!QUOTE] Суть
> 4 типа вложенных классов: **Static nested** (нет ссылки на внешний), **Inner** (нестатический, хранит ссылку на внешний → утечка памяти!), **Local** (внутри метода), **Anonymous** (анонимный). Builder паттерн — решение для объектов со многими параметрами вместо телескопических конструкторов.
...
> [!WARNING] Ловушка: нестатический inner class = неявная ссылка на outer
> Нестатический внутренний класс неявно хранит ссылку `Outer.this`. Пока жив inner, outer не будет собран GC — **утечка памяти**. Особенно опасно в Android и долгоживущих коллекциях. Используй `static` nested class если доступ к outer не нужен.
