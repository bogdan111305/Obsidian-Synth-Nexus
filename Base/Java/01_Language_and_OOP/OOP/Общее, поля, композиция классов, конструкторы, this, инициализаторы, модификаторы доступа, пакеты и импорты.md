---
title: "Java — Классы, поля, конструкторы, модификаторы доступа, пакеты"
tags: [java, oop, classes, constructors, this, access-modifiers, packages]
updated: 2026-03-04
---

# Классы и объекты: поля, конструкторы, this, пакеты

> [!QUOTE] Суть
> **Класс** — шаблон с полями (состояние) и методами (поведение). **Объект** — экземпляр класса в heap. `this` — ссылка на текущий объект. Конструктор без параметров генерируется компилятором автоматически, **только если не объявлен явный конструктор**.
