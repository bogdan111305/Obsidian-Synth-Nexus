...
> JIT (Just-In-Time) компилятор — сердце производительности JVM. Понимание его работы позволяет писать код, который JVM может оптимизировать до уровня нативного C++.
