# Приведение типов в Java: widening и narrowing conversion

## Содержание

1. [Основы приведения типов](#основы-приведения-типов)
2. [Приведение примитивных типов](#приведение-примитивных-типов)
3. [Приведение ссылочных типов](#приведение-ссылочных-типов)
4. [Pattern Matching для instanceof](#pattern-matching-для-instanceof)
5. [Приведение с коллекциями](#приведение-с-коллекциями)
6. [JVM-реализация](#jvm-реализация)
7. [Производительность и оптимизация](#производительность-и-оптимизация)
8. [Дополнительные сценарии](#дополнительные-сценарии)
9. [Типичные проблемы и решения](#типичные-проблемы-и-решения)
10. [Лучшие практики](#лучшие-практики)
11. [Вопросы для собеседования](#вопросы-для-собеседования)
