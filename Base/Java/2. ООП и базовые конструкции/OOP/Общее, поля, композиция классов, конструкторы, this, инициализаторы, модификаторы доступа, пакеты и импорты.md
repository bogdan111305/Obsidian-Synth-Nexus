...
1. [Основы классов и объектов](#основы-классов-и-объектов)
2. [Поля и переменные](#поля-и-переменные)
3. [Конструкторы и инициализация](#конструкторы-и-инициализация)
4. [Композиция классов](#композиция-классов)
5. [Модификаторы доступа](#модификаторы-доступа)
6. [Пакеты и импорты](#пакеты-и-импорты)
...
10. [Современные возможности Java](#современные-возможности-java)
