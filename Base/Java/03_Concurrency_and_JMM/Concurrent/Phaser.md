...
> [!QUOTE] Суть
> **Phaser** = CyclicBarrier + CountDownLatch + динамические участники. Поддерживает несколько фаз, участники могут регистрироваться (`register()`) и отрегистрироваться (`arriveAndDeregister()`) во время работы. Наиболее гибкий синхронизатор, но и наиболее сложный.
