...
## Связанные темы
[[G1GC — архитектура и tuning]], [[ZGC и Generational ZGC]], [[JVM флаги для GC]], [[Java Memory Structure]], [[GC Roots и достижимость объектов]], [[Safepoints и Stop-The-World]], [[Выбор GC — сравнительная таблица]]
