...
## Связанные темы
[[G1GC — архитектура и tuning]], [[ZGC и Generational ZGC]], [[Анализ GC логов — JFR, GCEasy]], [[GC и латентность — практика]], [[Java Memory Structure]], [[Выбор GC — сравнительная таблица]]
...
# Механизм и когда применять — см. [[Java String]] (раздел Senior Insights)
