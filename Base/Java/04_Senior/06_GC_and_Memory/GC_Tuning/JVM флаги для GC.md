...
## Связанные темы
[[G1GC — архитектура и tuning]], [[ZGC и Generational ZGC]], [[Анализ GC логов — JFR, GCEasy]], [[GC и латентность — практика]], [[Структура памяти JVM]], [[Выбор GC — сравнительная таблица]]
