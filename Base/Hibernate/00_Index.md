...
| Уровень | Раздел | Путь |
|---|---|---|
| **02_Middle** | 1. Основы (mapping, batch, dirty checking, equals/hashCode для Entity) | `02_Middle/1. Основы/` |
| | 2. Entity Associations (OneToMany, ManyToMany, каскады, коллекции) | `02_Middle/2. Entity Associations/` |
| | 3. Hibernate querying (HQL, Criteria API, Querydsl) | `02_Middle/3. Hibernate querying/` |
| | 4. N + 1 выборок (обнаружение и решения) | `02_Middle/4. N + 1 выборок в Hibernate/` |
| | 9. DAO & Repository (CRUD, Bean Validation) | `02_Middle/9. DAO & Repository/` |
